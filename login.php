...
// In auth_status.php and logout.php
...
<head>
    ...
    <link rel="stylesheet" href="login.css"> <!-- Include your login.css file -->
    <style>
...
<body>
    <div class="login">
        <div class="container-1">
            <div class="wrapper">
                <h2>Login</h2>
                <p>Connecting with You, Every Step of the Way!</p>
                ...
                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                    <div class="form-group">
                        <div class="group-1">
                            <div class="frame-1">
                                <img class="vector-1" src="assets/vectors/Vector8_x2.svg" alt="username" />
                            </div>
                    ...
                    <div class="form-group">
                        <div class="group-2">
                            <div class="frame">
                                <img class="vector" src="assets/vectors/Vector18_x2.svg" alt="password" />
                            </div>
